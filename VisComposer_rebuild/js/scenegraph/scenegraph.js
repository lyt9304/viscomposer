viscomposer.scenegraph.Scenegraph=(function(){
	var Node=viscomposer.scenegraph.Node;
	...
	var Scenegraph=viscomposer.VObject.define("Scenegraph",null,function(){
        ...
        viscomposer.app.uiManager.disableRender();
        ...
        viscomposer.app.uiManager.enableRender();
	});
	...
	Object.defineProperty(prototype,"root",{
		...
		set:function(x){root=x;}
	});

	Object.defineProperty(prototype,"properties",{
		get:function(){return properties;},
		set:function(x){properties=x;}
	});

	var init=prototype.init=function(){
		root=new Node(this,{isRoot:true});
        //viscomposer.app.selectedNode=root;
		viscomposer.app.uiManager.createScenegraph(this);
	};

    prototype.newNode=function(parent,type,properties,predefinedLabel){
        viscomposer.app.uiManager.disableRender();

        //var newNode=new Node(this.scenegraph,{parent:this});
        //this.children.push(newNode);

        properties=properties||{};
        //parent=parent||null;

        var node=new viscomposer.scenegraph.Node(this,{"parent":parent});
        ...
        //TODO:primitiveRegistry
        //var moduleClass=viscomposer.util.primitiveRegistry[type];
        //
        //if(moduleClass){
        ...
        //}else{
            var module=new viscomposer.workflow.View(workflow,properties);
            workflow.addModule(module);
            node.type='view';
            node.label='view';
    ...
    prototype.getEnv=prototype.getEnv_=function(){
    ...
    prototype.run=function(simplify){

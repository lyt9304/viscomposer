 ...
 */
viscomposer.workflow.Workflow=function(node){
...
viscomposer.workflow.Workflow.prototype=Object.create(viscomposer.Object.prototype);
viscomposer.workflow.Workflow.prototype.constructor=viscomposer.workflow.Workflow;

viscomposer.workflow.Workflow.prototype.clone=function(){
    var newObj=new viscomposer.workflow.Workflow();
    newObj.copy(this);

    return newObj;
}

viscomposer.workflow.Workflow.prototype.copy=function(rhs){
    if(!rhs){return;}
    
    viscomposer.Object.prototype.copy.call(this,rhs);

    // copy modules in list
};

viscomposer.workflow.Workflow.prototype.destroy=function(){
...
viscomposer.workflow.Workflow.prototype.updateExternalPorts=function(){
...
viscomposer.workflow.Workflow.prototype.getExternalPorts=function(){
...
viscomposer.workflow.Workflow.prototype.updateInternalPorts=function(){
    return this.gen_internalPorts=this.header.getInternalPorts();
};
viscomposer.workflow.Workflow.prototype.getInternalPorts=function(){
...
viscomposer.workflow.Workflow.prototype.updateOutputPorts=function(){
    var output=[];
...
viscomposer.workflow.Workflow.prototype.getOutputPorts=function(){
...
viscomposer.workflow.Workflow.prototype.updateImportedData=function(){
    return this.gen_importedData=this.header.getImportedData();
}
viscomposer.workflow.Workflow.prototype.getImportedData=function(){
...
viscomposer.workflow.Workflow.prototype.updateGeometryOutputs=function(){
    var geoOutput=[];
...
viscomposer.workflow.Workflow.prototype.getGeometryOutputs=function(){
...
viscomposer.workflow.Workflow.prototype.updateEnvironmentOutputs=function(){
    var envOutput=[];
    var moduleList=this.moduleList;
    for(key in moduleList){
        var module=moduleList[key];
...
viscomposer.workflow.Workflow.prototype.getEnvironmentOutputs=function(){
    if(!this.gen_envOutputs){
        this.updateEnvironmentOutputs();
    }
    return this.gen_envOutputs;
}
viscomposer.workflow.Workflow.prototype.hasLayout=function(){
...
viscomposer.workflow.Workflow.prototype.getEnv_=function(){
...
viscomposer.workflow.Workflow.prototype.getEnv=function(){
    return this.node.parent.getEnv_();
}

viscomposer.workflow.Workflow.prototype.prepare=function(simplify){
...
viscomposer.workflow.Workflow.prototype.update=function(){
...
viscomposer.workflow.Workflow.prototype.addData=function(dataInfo){
...
viscomposer.workflow.Workflow.prototype.addPort=function(label,varname,selector){
...
viscomposer.workflow.Workflow.prototype.addModule=function(module){
...
viscomposer.workflow.Workflow.prototype.removeModule=function(module){
...
viscomposer.workflow.Workflow.prototype.addLink=function(port1,port2){
...
viscomposer.workflow.Workflow.prototype.removeLink=function(link){
    link.destroy();
};

viscomposer.workflow.Workflow.prototype.topoSort=function(){
...
viscomposer.workflow.Workflow.prototype.createTemplate=function(simplify){
    var topoRes=this.topoSort();
    if(!topoRes){return;}
...
viscomposer.workflow.Workflow.prototype.store=function(){
...
viscomposer.workflow.Workflow.load=function(hashmap,obj){
    var workflow=new viscomposer.workflow.Workflow();
    hashmap[obj.uuid]=workflow;

    workflow.label=obj.label;
    workflow.funName=obj.funName;
    workflow.resName=obj.resName;
    workflow.header=viscomposer.workflow.WorkflowHeader.load(hashmap,obj.header,workflow);

    for(var i=0,ni=obj.moduleList.length;i<ni;++i){
        var module=viscomposer.workflow.Module.load(hashmap,obj.moduleList[i]);
        workflow.moduleList[module.uuid]=module;
        module.funName=viscomposer.util.processConflict(module.funName,workflow.moduleFunNames);
        module.workflow=workflow;
    }

    for(var i=0,ni=obj.linkList.length;i<ni;++i){
        var link=viscomposer.workflow.Link.load(hashmap,obj.linkList[i]);
    }

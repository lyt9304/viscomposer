...
viscomposer.ui.FilterPanelUI= (function(){
    var FilterPanelUI=viscomposer.VObject.define("FilterPanelUI","ModuleUI",function(filterModule, workflowWindow){

            this.obj = filterModule;
    ...
    var prototype=FilterPanelUI.prototype;
            ...
            if(that.selectedCol != 'coding')
            {
                ...
                if(dataType.label == "quantitative")
                {
                    ...
                    $(that.elSelector + ' .option .checkboxset .item input').on("click", function(){
                        ...
                        (that.obj.properties.cols[that.selectedCol])[key] = checked;
                        viscomposer.app.tryRender();
                    });
